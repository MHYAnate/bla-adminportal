...
// Define local Customer interface to match what CustomerTable expects
interface Customer {
	name: string;
	email: string;
	type: "individual" | "business";  // Specific union type, not generic string
	totalSpent: number;
}
...
const FinancialReport: React.FC = () => {
	...
	// Transform API customers data to match Customer interface with correct type
