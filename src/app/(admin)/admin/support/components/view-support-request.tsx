...
// 		console.log(adminsData,"admin")

// 		console.log(rolesData, "role")

// 	console.log(supportRequest, "reqs");
...
// 		if (
// 			isValidStatusTransition &&
// 			!isValidStatusTransition(supportRequest.status, data.status)
// 		) {
// 			toast.error(
// 				`Invalid status transition from ${supportRequest.status} to ${data.status}`
// 			);
...
// 			!supportRequest.hasInternalNotes &&
// 			!trackingForm.getValues().internalNotes
// 		) {
...
// 	console.log(supportRequest, "supreq");
...
// 						<p className="text-sm font-medium text-gray-600">Support ID</p>
// 						<p className="text-lg font-semibold">
// 							{currentData.supportId || `SUP-${currentData.id}`}
// 						</p>
// 					</div>
// 					<div>
// 						<p className="text-sm font-medium text-gray-600">Status</p>
...
// 							className={`${
// 								getStatusBadgeColor
// 									? getStatusBadgeColor(currentData.status)
...
// 									? getPriorityBadgeColor(currentData.priority)
// 									: "bg-gray-100 text-gray-800"
// 							} mt-1`}
// 						>
// 							{currentData.priority || "MEDIUM"}
...
// 						<p className="text-sm font-medium text-gray-600">Type</p>
// 						<p>
// 							{currentData.customer?.type || currentData.user?.type || "N/A"}
// 						</p>
// 					</div>
// 					<div>
...
// 								<span className="font-medium">Assigned Admin:</span>
// 								<span className="ml-2">
// 									{currentData.assignedAdmin?.name || "Unassigned"}
// 								</span>
// 							</div>
// 							<div>
// 								<span className="font-medium">Resolution Channel:</span>
...
// 											<Textarea
// 												placeholder={
// 													detailData?.internalNotes
// 														? detailData?.internalNotes
// 														: "Add internal notes (required before marking as resolved)..."
// 												}
// 												className="min-h-[120px]"
// 												{...field}
// 											/>
...
//   //   return adminsData.filter(admin => {
//   //     // Check if admin is active and has admin privileges
//   //     const isActiveAdmin = admin.isActive && 
//   //       (admin.type === 'ADMIN' || admin.type === 'SUPER_ADMIN');
      
//   //     // Check if admin has customer service role
//   //     const hasCustomerServiceRole = admin.roles?.some((role: any) => 
//   //       role.role?.name === "CUSTOMER_SERVICE" || 
//   //       role.role?.name === "Customer Relations Manager"
//   //     );
      
//   //     return isActiveAdmin && hasCustomerServiceRole;
//   //   });
//   // }, [adminsData]);
...
//                 <span className="font-medium">Assigned Admin:</span>
//                 <span className="ml-2">
//                   {currentData.assignedAdmin?.profile?.fullName || "Unassigned"}
//                 </span>
//               </div>
//               <div>
//                 <span className="font-medium">Resolution Channel:</span>
...
//     console.log("Tracking update data received:", data);
//     console.log("Support request ID:", supportRequest.id);

//     if (trackingMutation?.mutateAsync) {
//       // Call the API with the exact structure the backend expects
//       await trackingMutation.mutateAsync({
//         supportId: supportRequest.id,
//         data: {
//           assignedAdminId: data.assignedAdminId,
