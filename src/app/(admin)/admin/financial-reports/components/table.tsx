...
const CustomerTable: React.FC<CustomerTableProps> = ({ data,refetch }) => {
  ...
  const [deleteDialogOpen, setDeleteDialogOpen] = useState(false);
	...
	// 			const typeMatch =
	// 				filters.type === "" ||
	// 				customer.type.toLowerCase() === filters.type.toLowerCase();
...
//       toast.success(`Customer ${customerToDelete.email} deleted successfully`);
//       setIsDeleteModalOpen(false);
//       setCustomerToDelete(null);
//       refetch();
//     }
...
//       <div className="flex justify-between items-start mb-3">
//         <div>
//           <h3 className="font-medium text-gray-900">{customer.email}</h3>
//         </div>
//         <span
//           className={`px-2.5 py-1 text-xs font-medium rounded-full border ${getTypeBadgeClass(
//             customer.type
...
//             </h3>
//             <p className="text-gray-600 text-center mb-6">
//               Are you sure you want to delete {customerToDelete?.email}? This action cannot be
//               undone.
//             </p>
//             <div className="flex justify-end gap-3">
//               <button
