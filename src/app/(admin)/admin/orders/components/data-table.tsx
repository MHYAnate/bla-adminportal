...
// //   // Handle view order details with proper navigation
// //   const handleViewOrder = useCallback((orderId: string | number) => {
// //     if (!orderId) {
// //       console.error("Invalid order ID for navigation:", orderId);
// //       toast.error("Invalid order ID");
...
// //   // Prevent event bubbling and add better click handling
// //   const handleActionClick = useCallback((e: React.MouseEvent, orderId: string) => {
// //     e.preventDefault();
// //     e.stopPropagation();
...
// //               {name}
// //             </p>
// //             {/* FIX: Made email smaller (text-xs), grayer (text-gray-400), and added proper wrapping */}
// //             <p className="font-normal text-xs text-gray-400 break-all leading-4 mt-0.5" 
// //                title={email}
// //                style={{ 
// //                  wordBreak: 'break-all',
...
// //       return (
// //         <div className="font-medium">
// //           <p className="capitalize text-gray-900 text-sm">
// //             {type}
// //           </p>
// //           <p className="font-normal text-xs text-gray-400 capitalize mt-0.5">
// //             {paymentStatus}
// //           </p>
// //         </div>
// //       );
...
// //             <p className="font-medium text-gray-900 truncate text-sm leading-5" title={productName}>
// //               {productName}
// //               {totalItems > 1 && (
...
// //               )}
// //             </p>
// //             <p className="font-normal text-xs text-gray-400 truncate mt-0.5" title={brand}>
// //               {brand}
// //             </p>
// //           </div>
// //         </div>
...
// //         <Badge
// //           variant={getVariant(frontendStatus)}
// //           className={`capitalize text-xs ${getBadgeColor(frontendStatus)}`}
// //         >
// //           {frontendStatus}
// //         </Badge>
// //       );
...
// //               handleViewOrder(orderId);
// //             }}
// //             className="text-blue-600 hover:text-blue-700 hover:bg-blue-50 flex items-center gap-1 transition-colors duration-200 h-8 px-3 text-xs"
// //             title={`View Order Details for #${orderId}`}
// //           >
...
// //           <div className="space-y-3">
// //             {[...Array(5)].map((_, index) => (
// //               <div key={index} className="h-14 bg-gray-200 rounded animate-pulse"></div>
// //             ))}
// //           </div>
// //           <div className="mt-4 flex justify-between items-center">
// //             <div className="h-4 bg-gray-200 rounded w-32 animate-pulse"></div>
