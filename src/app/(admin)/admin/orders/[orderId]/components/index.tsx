...
// 										<p className="font-medium">
// 											{product.processingTimeDays || "N/A"} days
// 										</p>
// 									</div>
// 									<div>
...
// 		const getTrackingSteps = useMemo(
...
// 									>
// 										<div
// 											className={`w-12 h-12 rounded-full flex items-center justify-center mb-2 border-4 border-white shadow-sm ${
...
// 		if (
// 			processedOrderData.status === "DELIVERED" ||
// 			processedOrderData.status === "COMPLETED"
// 		) {
// 			return [];
// 		}
...
// 						Error Loading Order
// 					</h2>
// 					<p className="text-gray-600 mb-6">{getOrderInfoError}</p>
...
// 																	onClick={() =>
// 																		handleStatusUpdate(transition.value)
// 																	}
...
// 												{
// 													label: "Processing",
// 													status: ["PROCESSING", "ONGOING"].includes(
// 														order.status
// 													)
// 														? "current"
...
// 														"COMPLETED",
// 													].includes(order.status),
// 													showSpinner: ["PROCESSING", "ONGOING"].includes(
// 														order.status
// 													),
// 												},
// 												{
...
// 											<p className="font-medium">
// 												{processedOrderData.shipping.paymentType}
// 											</p>
// 										</div>
// 										<div>
...
// 											<Badge
// 												variant={
// 													paymentInfo.isScheduled ? "secondary" : "default"
// 												}
// 												className="ml-2"
// 											>
...
// 																	Changed from {event.details.previousStatus} to{" "}
// 																	{event.status}
// 																</span>
// 															</div>
// 														)}
...
// 									<CardTitle>
// 										{" "}
// 										<p className="text-sm text-gray-700 break-words overflow-hidden whitespace-normal mx-auto">
// 											{profile?.fullName ||
...
// 											<p className="font-medium">
// 												{shippingAddress?.stateProvince || "N/A"}
// 											</p>
// 										</div>
// 										<div className="flex items-center">
...
// 										<span className="text-gray-600">Shipping Fee:</span>
// 										<span className="font-medium">
// 											₦{processedOrderData?.shipping?.totalShippingFee || "N/A"}
// 										</span>
// 									</div>
// 									{/* <div className="flex justify-between">
...
const OrderDetails: React.FC<OrderDetailsProps> = ({
	...
	const searchParams = useSearchParams();
	const returnPage = searchParams.get("page") || "1"; // FIXED: Get the page from URL params
	const router = useRouter();
	const [trackingModalOpen, setTrackingModalOpen] = useState(false);
	const [productModalOpen, setProductModalOpen] = useState(false);
	const [selectedProduct, setSelectedProduct] = useState(null);
	...
	// FIXED: Navigate back to the orders page with the current page from URL params
	const handleBackToOrders = useCallback(() => {
		router.push(`/admin/orders?page=${returnPage}`);
	}, [router, returnPage]);
