...
// import { useGetPendingInvitations, useResendAdminInvite, useCancelInvitation } from "@/services/admin";
...
//         refetchInvitations
//     } = useGetPendingInvitations({ enabled: true });

//     console.log(invitationsData, "inviteData")
...
//     const { cancelInvitationPayload, cancelInvitationIsLoading } = useCancelInvitation(() => {
//         refetchInvitations();
//         setSelectedInvitation(null);
//         setActionType(null);
//     });
...
//     const openActionDialog = (invitation: PendingInvitation, action: 'resend' | 'cancel') => {
...
//             case 'PENDING':
//                 return <Badge variant="tertiary" className="text-xs">Pending</Badge>;
//             case 'RESENT':
//                 return <Badge variant="secondary" className="text-xs">Resent</Badge>;
//             case 'COMPLETED':
//                 return <Badge variant="success" className="text-xs">Completed</Badge>; 
//             case 'CANCELLED':
//                 return <Badge variant="warning" className="text-xs">Cancelled</Badge>;
//             default:
//                 return <Badge variant="outline" className="text-xs">{invitation.status}</Badge>;
//         }
//     };
...
//                                     <div
//                                         key={invitation.id}
//                                         className={`border rounded-lg p-4 transition-colors ${expired ? 'border-red-200 bg-red-50' : 'border-gray-200 hover:border-gray-300'
//                                             }`}
//                                     >
...
//                                                         <span>Role: {invitation.role.name.replace(/_/g, ' ')}</span>
//                                                     </div>
...
//                                                     <div className={`flex items-center gap-1 ${expired ? 'text-red-600' : 'text-amber-600'
//                                                         }`}>
...
//                                                 {invitation.status !== 'CANCELLED' && invitation.status !== 'COMPLETED' && (
//                                                     <Button
//                                                         variant="outline"
//                                                         size="sm"
//                                                         onClick={() => openActionDialog(invitation, 'resend')}
...
//                                                         variant="outline"
//                                                         size="sm"
//                                                         onClick={() => openActionDialog(invitation, 'cancel')}
...
//                                 All admin invitations have been completed or there are no active invitations.
//                             </p>
//                         </div>
//                     )}
//                 </CardContent>
...
//             {/* Action Dialog */}
//             <Dialog open={!!selectedInvitation && !!actionType} onOpenChange={closeDialog}>
...
//                                             <span className="font-medium">{selectedInvitation.status}</span>
//                                         </div>
//                                         <div className="flex justify-between">
...
//                             onClick={actionType === 'resend' ? handleResendInvite : handleCancelInvitation}
...
//   useEffect(() => {
//     if (invitationsData && totalInvitations) {
//       setPagination(prev => ({
//         ...prev,
...
//       }));
//     }
//   }, [invitationsData, totalInvitations]);
...
//               </div> */}
//               { (
//   <div className="flex flex-col md:flex-row items-center justify-between mt-6 border-t border-gray-200 pt-4 gap-4">
//     {/* Entry Range Display */}
...
//       <div className="px-3 py-1 text-sm font-medium text-gray-700 bg-gray-50 rounded whitespace-nowrap">
...
const mockInvitations: PendingInvitation[] = [
    {
        ...
        role: { id: 1, name: 'ADMIN', description: 'Full access to all settings.' },
        invitedBy: { id: 1, email: 'admin@example.com' },
        completedAt: null,
    },
    {
        id: '2',
        ...
        updatedAt: new Date().toISOString(),
        role: { id: 2, name: 'EDITOR', description: 'Can edit content.' },
        invitedBy: { id: 1, email: 'admin@example.com' },
