...
const PendingInvitations: React.FC = () => {
  ...
  const {
    ...
    enabled: true, 
    filter: { page: currentPage, limit: itemsPerPage } 
  });
  ...
  const endItem = Math.min(currentPage * itemsPerPage, totalInvitations);
            ...
            <>
              ...
              <div className="flex items-center justify-between">
                <div className="text-sm text-gray-600">
                  Showing {startItem} to {endItem} of {totalInvitations} invitations
                </div>
